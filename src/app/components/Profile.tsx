  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="px-4 -mt-8">
        <Card
          className={`p-6 border border-border bg-card shadow-xl dark:shadow-2xl dark:shadow-blue-900/20 ${
            canSwitchAccounts ? 'cursor-pointer active:scale-[0.98] transition-transform' : ''
          }`}
