...
export function AddExpense() {
  ...
  const handleSave = () => {
    ...
    setDescription("");
    setAmount("");
    setExpenseType("shop"); // Reset to default
  };

  const handleEdit = (expense: any) => {
    setDescription(expense.description);
    setAmount(expense.amount.toString());
    setExpenseType(expense.expenseType || "shop");
      ...
      <div className="p-4 space-y-6">
        ...
        <Card className="p-6 dark:bg-gray-800 dark:border-gray-700">
          ...
          <select
            ...
            onChange={(e) =>
              setExpenseType(
                e.target.value as "personal" | "shop",
              )
            }
            className="w-full h-12 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-3 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            <option value="shop">Do'kon uchun</option>
            <option value="personal">O'zim uchun</option>
          </select>
